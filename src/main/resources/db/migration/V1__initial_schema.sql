...
CREATE TABLE customers (
                           ...
                           preferred_channel   VARCHAR(100) NOT NULL DEFAULT 'EMAIL',
...
CREATE TABLE loan_products (
                               ...
                               loan_type               VARCHAR(100) NOT NULL DEFAULT 'LUMP_SUM',
                               installment_count       INTEGER,
                               billing_cycle_type      VARCHAR(100) NOT NULL DEFAULT 'INDIVIDUAL',
